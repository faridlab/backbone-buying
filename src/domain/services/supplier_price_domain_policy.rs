//! Domain policy for SupplierPrice aggregate
//!
...
/// Domain policy for SupplierPrice — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<SupplierPrice>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type SupplierPriceDomainPolicy = PermitAllPolicy<SupplierPrice>;
