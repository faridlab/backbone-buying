//! Domain policy for PurchaseOrderItem aggregate
//!
...
/// Domain policy for PurchaseOrderItem — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PurchaseOrderItem>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PurchaseOrderItemDomainPolicy = PermitAllPolicy<PurchaseOrderItem>;
