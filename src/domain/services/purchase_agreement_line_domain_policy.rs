//! Domain policy for PurchaseAgreementLine aggregate
//!
...
/// Domain policy for PurchaseAgreementLine — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PurchaseAgreementLine>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PurchaseAgreementLineDomainPolicy = PermitAllPolicy<PurchaseAgreementLine>;
