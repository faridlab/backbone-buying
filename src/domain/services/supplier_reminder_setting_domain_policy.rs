//! Domain policy for SupplierReminderSetting aggregate
//!
...
/// Domain policy for SupplierReminderSetting — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<SupplierReminderSetting>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type SupplierReminderSettingDomainPolicy = PermitAllPolicy<SupplierReminderSetting>;
