//! Specifications for RequestForQuotation aggregate
//!
...
// Each predicate implements `Specification<RequestForQuotation>` and can be combined
...
//
// pub struct ActiveRequestForQuotationSpec;
// impl Specification<RequestForQuotation> for ActiveRequestForQuotationSpec {
//     fn is_satisfied_by(&self, e: &RequestForQuotation) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
