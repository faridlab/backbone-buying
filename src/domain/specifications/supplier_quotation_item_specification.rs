//! Specifications for SupplierQuotationItem aggregate
//!
...
// Each predicate implements `Specification<SupplierQuotationItem>` and can be combined
...
//
// pub struct ActiveSupplierQuotationItemSpec;
// impl Specification<SupplierQuotationItem> for ActiveSupplierQuotationItemSpec {
//     fn is_satisfied_by(&self, e: &SupplierQuotationItem) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
