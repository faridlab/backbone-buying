//! Specifications for SupplierPrice aggregate
//!
...
// Each predicate implements `Specification<SupplierPrice>` and can be combined
...
//
// pub struct ActiveSupplierPriceSpec;
// impl Specification<SupplierPrice> for ActiveSupplierPriceSpec {
//     fn is_satisfied_by(&self, e: &SupplierPrice) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
