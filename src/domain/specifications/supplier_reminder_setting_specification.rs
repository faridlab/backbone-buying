//! Specifications for SupplierReminderSetting aggregate
//!
...
// Each predicate implements `Specification<SupplierReminderSetting>` and can be combined
...
//
// pub struct ActiveSupplierReminderSettingSpec;
// impl Specification<SupplierReminderSetting> for ActiveSupplierReminderSettingSpec {
//     fn is_satisfied_by(&self, e: &SupplierReminderSetting) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
