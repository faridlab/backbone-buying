//! Specifications for PurchaseAgreement aggregate
//!
...
// Each predicate implements `Specification<PurchaseAgreement>` and can be combined
...
//
// pub struct ActivePurchaseAgreementSpec;
// impl Specification<PurchaseAgreement> for ActivePurchaseAgreementSpec {
//     fn is_satisfied_by(&self, e: &PurchaseAgreement) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
