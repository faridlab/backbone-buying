//! Specifications for SupplierQuotation aggregate
//!
...
// Each predicate implements `Specification<SupplierQuotation>` and can be combined
...
//
// pub struct ActiveSupplierQuotationSpec;
// impl Specification<SupplierQuotation> for ActiveSupplierQuotationSpec {
//     fn is_satisfied_by(&self, e: &SupplierQuotation) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
