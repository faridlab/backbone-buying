//! Specifications for MaterialRequestItem aggregate
//!
...
// Each predicate implements `Specification<MaterialRequestItem>` and can be combined
...
//
// pub struct ActiveMaterialRequestItemSpec;
// impl Specification<MaterialRequestItem> for ActiveMaterialRequestItemSpec {
//     fn is_satisfied_by(&self, e: &MaterialRequestItem) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
