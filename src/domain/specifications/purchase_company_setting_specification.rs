//! Specifications for PurchaseCompanySetting aggregate
//!
...
// Each predicate implements `Specification<PurchaseCompanySetting>` and can be combined
...
//
// pub struct ActivePurchaseCompanySettingSpec;
// impl Specification<PurchaseCompanySetting> for ActivePurchaseCompanySettingSpec {
//     fn is_satisfied_by(&self, e: &PurchaseCompanySetting) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
